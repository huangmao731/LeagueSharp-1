...
namespace ShineSharp.Champions
{
    public class Amumu : BaseChamp
    {
        ...
        public override void SetSpells()
        {
            ...
            Spells[Q].SetSkillshot(0.25f, 90f, 2000f, true, SkillshotType.SkillshotLine);
        ...
        {
            if (sender.IsEnemy && sender.IsChampion() && ShineCommon.Utility.IsImmobileTarget(sender as Obj_AI_Hero) && Spells[Q].IsInRange(sender) && misc.Item("MAUTOQIMMO").GetValue<bool>())
                if (Spells[Q].IsReady())
